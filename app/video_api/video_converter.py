...
def download_youtube_video(url):
    ...
    video_path = filer.find_tmp_file(id, "mp4")
    ...
    video_path = filer.find_and_format_file(id, "video", "mp4")
    srt_path = filer.find_and_format_file(id, "subs", "srt")
    info_path = filer.find_and_format_file(id, "info", "json")
